//#include<iostream>
//using namespace std;
//// Fungsi untuk menukar 2 elemen pada array
...
// 	arr[pos2]=temp;
// }
//// Fungsi untuk mengembalikan posisi dari pivot setelah dipartisi
// int partition(int arr[],int low,int high,int pivot){
// 	int i=low;
// 	int j=low;
// 	// Melakukan pengulangan sampai batas high
// 	while (i<=high){
// 		// Jika elemen lebih besar dari pivot, maka i++
// 		if(arr[i]>pivot){
// 			i++;
//		 }
//		 // Jika elemen lebih kecil dari pivot, maka menukar antara arr[i] dan arr[j]
//		 else{
//		 	swap(arr,i,j);
//		 	i++;
//		 	j++;
//		 }
//	 }
//	 // Mengembalikan posisi pivot setelah di partisi
//	 return j-1;
// }
...
// 		int pivot =arr[high];
// 		// Memanggil fungsi partition untuk mengembalikan posisi pivot setelah di partisi
